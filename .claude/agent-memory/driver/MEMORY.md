...
- [BYOK to Anthropic without the SDK](feedback_byok_browser_anthropic.md) — raw fetch + `anthropic-dangerous-direct-browser-access: true` works; no need for `@anthropic-ai/sdk` + `dangerouslyAllowBrowser`.
